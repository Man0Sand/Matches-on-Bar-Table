...
namespace
{
	...
	protected:
        virtual void SetUp()
        {
            ...
            {
                p_players.push_back(Player::create(kb_buffer_mock, 42, player_settings.player_config[i], p_match_pile));
            }
        ...
        cl_game::T_player_settings player_settings = { cl_game::TWO,{ { "Tietsari 1", Player::COMPUTER, Player::HARD },{ "Tietsari 2", Player::COMPUTER, Player::HARD } } };
